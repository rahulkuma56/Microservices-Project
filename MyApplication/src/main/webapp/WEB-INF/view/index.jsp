...
<body onload="myFunction();">
	...
	<div id="first">
		...
		<div id="intro"
			...
			<div class="btn btn-icon float">
				<a href="/login"> <i class="fa fa-code round_circle"
					...
					<p class="icon_txt" style="margin-top: -8px;">Login</p>
				</a>
			</div>
			<div class="btn btn-icon float">
				<a href="/show-users"> <i class="fa fa-laptop round_circle"></i>
					<p class="icon_txt">Services</p>
				</a>
			</div>
			<div class="btn btn-icon float">
				<a href="/allquotes"> <i class="fa fa-dropbox round_circle"></i>
			...
			<div class="btn btn-icon float">
				<a href="/"> <i class="fa fa-phone round_circle"></i>
					<p class="icon_txt">Contact</p>
				</a>
			</div>
		</div>
		<div id="intro">
			<a><p class="title">Microservices Example Project</p></a>
		</div>
